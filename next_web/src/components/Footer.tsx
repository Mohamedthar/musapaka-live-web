  ...
  return (
    <footer className="w-full bg-gradient-to-b from-[#002117] to-[#003527] text-white relative overflow-hidden" dir="rtl">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-5 py-10 lg:py-14">
        <div className="w-16 h-[2px] bg-secondary-fixed/70 mx-auto mb-8 rounded-full" />

        <div className="grid grid-cols-2 md:grid-cols-12 gap-5 md:gap-5 lg:gap-4">
          <div className="col-span-2 md:col-span-12 lg:col-span-6 flex flex-col items-center lg:items-start text-center lg:text-right gap-3">
            <h3
            ...
            <div className="flex flex-col items-center lg:items-start gap-2">
              {phones.map((phone) => (
                <a key={phone} href={`https://wa.me/20${phone.replace(/^0/, '')}`} target="_blank" rel="noopener noreferrer"
                  className="group text-white/40 hover:text-secondary-fixed transition-colors text-sm lg:text-base font-bold flex items-center gap-2" dir="ltr">
