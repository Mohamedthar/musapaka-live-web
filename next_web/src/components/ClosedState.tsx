...
const configs = {
  form: {
    ...
    desc: 'باب التسجيل مغلق حالياً. سيتم فتح الاستعلام عن الاستمارات بعد انتهاء فترة التسجيل الرسمية المُعلن عنها في ورقة الإعلان عن المسابقة.',
  },
  result: {
    icon: Award,
    title: 'نتائج المسابقة',
    desc: 'النتائج لم تُعلن بعد. سيتم فتح هذا القسم بعد انتهاء الاختبارات وإعلان النتائج الرسمية من قبل إدارة المسابقة.',
  },
  ceremony: {
    icon: CalendarCheck,
    title: 'حفل التكريم',
    desc: 'هذا القسم غير متاح حالياً. سيتم فتحه بعد إعلان النتائج النهائية وتحديد موعد حفل التكريم.',
  },
};
