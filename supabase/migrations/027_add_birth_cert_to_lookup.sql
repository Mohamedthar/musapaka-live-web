-- Migration: Add birth_certificate_url to public_lookup_student function
-- Purpose: Include birth certificate image in student inquiry response (for form printing)
...
BEGIN
    ...
    SELECT
        ...
        s.exam_date, s.exam_hour, s.score, s.profile_image_url, s.birth_certificate_url,
